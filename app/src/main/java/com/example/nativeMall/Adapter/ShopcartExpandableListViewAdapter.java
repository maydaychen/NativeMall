...
public class ShopcartExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            cholder.iv_gouwuche = (SmartImageView) convertView.findViewById(R.id.iv_med_pic);
        ...
        if (product != null) {
            ...
            cholder.iv_gouwuche.setImageUrl(Config.PIC_URL + product.getImageUrl());
            ...
            if (product.getCount() == 1){
                cholder.iv_decrease.setTextColor(context.getResources().getColor(R.color.font_colour_99));
            }else {
                cholder.iv_decrease.setTextColor(context.getResources().getColor(R.color.black));
            }
        }
        return convertView;
    }
